...
/**
 ...
 <br>
 <ul>
 <li> Xcode 7 with the iOS 8 SDK</li>
 </ul>
 
 <b>Getting Started</b>
 <br>
 To get started, visit https://github.com/Affectiva/ios-sdk-samples and pull down the source for our demo apps. Ensure that the Code Signing settings for the various projects are setup correctly. The identity is setup for "iPhone Developer" which should match your identity automatically.
 ￼
...
/**
 \brief
 Glasses defines the enumerations for faces with and wihout glasses.
 */
typedef enum {
    AFDX_GLASSES_NO = 0,
    AFDX_GLASSES_YES = 1
...
/**
 \brief
 glasses is the detection of glasses on the face.
 */
...
/**
 \brief
 This contains the license provided by Affectiva.
 */
...
/**
 \brief
 Rotate a NSImage by the specified number of degrees.
 
 This method is useful for rotating NSImage objects.
